...
<Task> Convert the output of `exa mcp server --help` into clear, project-relevant Markdown documentation and write it to `claude.md`. </Task>
...
- Title: `exa MCP Server – Help Reference` 
- Brief intro 
- **Usage** section 
- **Commands** (if present) 
- **Flags/Options** 
